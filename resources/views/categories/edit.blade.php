<x-app-layout>
    <x-page-header title="Edit Category" :description="'Editing: ' . $category->name" />
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $category->description) }}</textarea>
                </div>
            </div>
