<x-app-layout>
    <x-page-header title="Categories" description="Manage your product categories">
        <x-slot name="actions">
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                ...
                <tr>
                    <td colspan="4" class="px-6 py-16 text-center">
                        <i class="ti ti-category-off text-4xl text-gray-200 dark:text-gray-700 block mb-3"></i>
